...
use Propel\Model\Quiz;
use Propel\Model\QuizQuery;
...
class QuizTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Model.Map.QuizTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Model\\Quiz';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Model.Quiz';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\Model\\Quiz');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\Model\Quiz) { // it's a model object
