...
class CategoriesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Model.Map.CategoriesTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Model\\Categories';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Model.Categories';
     ...
     */
    const COL_ID = 'categories.id';

    /**
     * the column name for the parent_id field
     */
    const COL_PARENT_ID = 'categories.parent_id';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'categories.name';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'ParentId', 'Name', ),
        self::TYPE_CAMELNAME     => array('id', 'parentId', 'name', ),
        self::TYPE_COLNAME       => array(CategoriesTableMap::COL_ID, CategoriesTableMap::COL_PARENT_ID, CategoriesTableMap::COL_NAME, ),
        self::TYPE_FIELDNAME     => array('id', 'parent_id', 'name', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'ParentId' => 1, 'Name' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'parentId' => 1, 'name' => 2, ),
        self::TYPE_COLNAME       => array(CategoriesTableMap::COL_ID => 0, CategoriesTableMap::COL_PARENT_ID => 1, CategoriesTableMap::COL_NAME => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'parent_id' => 1, 'name' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    protected $normalizedColumnNameMap = [
        ...
        'name' => 'NAME',
        'categories.name' => 'NAME',
        'CategoriesTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
        'name' => 'NAME',
        'categories.name' => 'NAME',
    ];
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\Model\\Categories');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CategoriesTableMap::COL_NAME);
        } else {
    ...
    public static function removeSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(CategoriesTableMap::COL_NAME);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\Model\Categories) { // it's a model object
