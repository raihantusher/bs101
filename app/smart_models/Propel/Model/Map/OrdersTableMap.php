...
class OrdersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Model.Map.OrdersTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Model\\Orders';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Model.Orders';
     ...
     */
    const COL_SHIPPING_COST = 'orders.shipping_cost';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'UserId', 'Note', 'FirstName', 'LastName', 'Mobile', 'Email', 'Region', 'City', 'Zip', 'Address', 'ShippingFirstName', 'ShippingLastName', 'ShippingMobile', 'ShippingEmail', 'ShippingRegion', 'ShippingCity', 'ShippingZip', 'ShippingAddress', 'ShippingCost', 'SellerNote', 'Status', 'CreatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'userId', 'note', 'firstName', 'lastName', 'mobile', 'email', 'region', 'city', 'zip', 'address', 'shippingFirstName', 'shippingLastName', 'shippingMobile', 'shippingEmail', 'shippingRegion', 'shippingCity', 'shippingZip', 'shippingAddress', 'shippingCost', 'sellerNote', 'status', 'createdAt', ),
        self::TYPE_COLNAME       => array(OrdersTableMap::COL_ID, OrdersTableMap::COL_USER_ID, OrdersTableMap::COL_NOTE, OrdersTableMap::COL_FIRST_NAME, OrdersTableMap::COL_LAST_NAME, OrdersTableMap::COL_MOBILE, OrdersTableMap::COL_EMAIL, OrdersTableMap::COL_REGION, OrdersTableMap::COL_CITY, OrdersTableMap::COL_ZIP, OrdersTableMap::COL_ADDRESS, OrdersTableMap::COL_SHIPPING_FIRST_NAME, OrdersTableMap::COL_SHIPPING_LAST_NAME, OrdersTableMap::COL_SHIPPING_MOBILE, OrdersTableMap::COL_SHIPPING_EMAIL, OrdersTableMap::COL_SHIPPING_REGION, OrdersTableMap::COL_SHIPPING_CITY, OrdersTableMap::COL_SHIPPING_ZIP, OrdersTableMap::COL_SHIPPING_ADDRESS, OrdersTableMap::COL_SHIPPING_COST, OrdersTableMap::COL_SELLER_NOTE, OrdersTableMap::COL_STATUS, OrdersTableMap::COL_CREATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'user_id', 'note', 'first_name', 'last_name', 'mobile', 'email', 'region', 'city', 'zip', 'address', 'shipping_first_name', 'shipping_last_name', 'shipping_mobile', 'shipping_email', 'shipping_region', 'shipping_city', 'shipping_zip', 'shipping_address', 'shipping_cost', 'seller_note', 'status', 'created_at', ),
    ...
    protected $normalizedColumnNameMap = [
        ...
        'shippingCost' => 'SHIPPING_COST',
        'orders.shippingCost' => 'SHIPPING_COST',
        'OrdersTableMap::COL_SHIPPING_COST' => 'SHIPPING_COST',
        'COL_SHIPPING_COST' => 'SHIPPING_COST',
        'shipping_cost' => 'SHIPPING_COST',
        'orders.shipping_cost' => 'SHIPPING_COST',
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\Model\\Orders');
        ...
        $this->addColumn('shipping_cost', 'ShippingCost', 'DECIMAL', true, null, null);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OrdersTableMap::COL_SHIPPING_COST);
            ...
            $criteria->addSelectColumn($alias . '.shipping_cost');
    ...
    public static function removeSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->removeSelectColumn(OrdersTableMap::COL_SHIPPING_COST);
            ...
            $criteria->removeSelectColumn($alias . '.shipping_cost');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\Model\Orders) { // it's a model object
