...
class ProductsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Model.Map.ProductsTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Model\\Products';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Model.Products';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Price', 'CategoryId', 'ProductImage', 'Description', 'Viewed', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'price', 'categoryId', 'productImage', 'description', 'viewed', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Price' => 2, 'CategoryId' => 3, 'ProductImage' => 4, 'Description' => 5, 'Viewed' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'price' => 2, 'categoryId' => 3, 'productImage' => 4, 'description' => 5, 'viewed' => 6, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\Model\\Products');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\Model\Products) { // it's a model object
