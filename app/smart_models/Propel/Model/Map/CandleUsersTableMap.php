...
class CandleUsersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Model.Map.CandleUsersTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Model\\CandleUsers';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Model.CandleUsers';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\Model\\CandleUsers');
    ...
    {
        $this->addRelation('CandleRole', '\\Propel\\Model\\CandleRole', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':role_id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\Model\CandleUsers) { // it's a model object
