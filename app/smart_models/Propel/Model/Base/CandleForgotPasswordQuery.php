...
use \Exception;
use Propel\Model\CandleForgotPassword as ChildCandleForgotPassword;
...
abstract class CandleForgotPasswordQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Propel\Model\Base\CandleForgotPasswordQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Propel\\Model\\CandleForgotPassword', $modelAlias = null)
    {
