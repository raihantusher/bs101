...
abstract class Products implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Model\\Map\\ProductsTableMap';
    ...
    /**
     * Initializes internal state of Propel\Model\Base\Products object.
     */
     ...
     * @return $this|\Propel\Model\Products The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProductsTableMap::translateFieldName('CategoryId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\Model\\Products'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Model\Products
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\Model\Products The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\Model\Products (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\Model\Products Clone of current object.
     * @throws PropelException
     */
    ...
    public function getCategory(ConnectionInterface $con = null)
    {
        if ($this->aCategory === null && ($this->category_id != 0)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aCategory->addProductss($this);
             */
        }
    ...
    {
        if (null !== $this->aCategory) {
            $this->aCategory->removeProducts($this);
        }
        $this->id = null;
        $this->name = null;
        $this->price = null;
