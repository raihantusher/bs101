 ...
 *
 * @method     \Propel\Model\CandleRoleQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class CandleUsersQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Propel\Model\Base\CandleUsersQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Propel\\Model\\CandleUsers', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Propel\Model\CandleRole object
     *
     * @param \Propel\Model\CandleRole|ObjectCollection $candleRole The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($candleRole instanceof \Propel\Model\CandleRole) {
            return $this
            ...
            throw new PropelException('filterByCandleRole() only accepts arguments of type \Propel\Model\CandleRole or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Propel\Model\CandleRoleQuery A secondary query class using the current class as primary query
     */
    public function useCandleRoleQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCandleRole($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'CandleRole', '\Propel\Model\CandleRoleQuery');
    }

    /**
     * Use the CandleRole relation CandleRole object
     *
     * @param callable(\Propel\Model\CandleRoleQuery):\Propel\Model\CandleRoleQuery $callable A function working on the related query
     *
