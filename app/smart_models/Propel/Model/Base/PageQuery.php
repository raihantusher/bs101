...
use \Exception;
use \PDO;
use Propel\Model\Page as ChildPage;
use Propel\Model\PageQuery as ChildPageQuery;
use Propel\Model\Map\PageTableMap;
 ...
 * @method     ChildPageQuery orderByArticle($order = Criteria::ASC) Order by the article column
 *
 * @method     ChildPageQuery groupById() Group by the id column
 * @method     ChildPageQuery groupByTitle() Group by the title column
 * @method     ChildPageQuery groupByArticle() Group by the article column
 *
 ...
 * @method     ChildPage|null findOneByArticle(string $article) Return the first ChildPage filtered by the article column *
 ...
 * @method     ChildPage requireOneByArticle(string $article) Return the first ChildPage filtered by the article column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildPage[]|ObjectCollection findByArticle(string $article) Return ChildPage objects filtered by the article column
...
abstract class PageQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Propel\Model\Base\PageQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Propel\\Model\\Page', $modelAlias = null)
    {
    ...
    public function filterByArticle($article = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PageTableMap::COL_ARTICLE, $article, $comparison);
    }
