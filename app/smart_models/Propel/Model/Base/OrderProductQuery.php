...
use \Exception;
use \PDO;
use Propel\Model\OrderProduct as ChildOrderProduct;
...
abstract class OrderProductQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Propel\Model\Base\OrderProductQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Propel\\Model\\OrderProduct', $modelAlias = null)
    {
