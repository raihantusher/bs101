 ...
 *
 * @method     \Propel\Model\CategoriesQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class ProductsQuery extends ModelCriteria
{
    ...
    /**
     * Filter the query by a related \Propel\Model\Categories object
     *
     * @param \Propel\Model\Categories|ObjectCollection $categories The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
    ...
    {
        if ($categories instanceof \Propel\Model\Categories) {
            return $this
            ...
            throw new PropelException('filterByCategory() only accepts arguments of type \Propel\Model\Categories or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Propel\Model\CategoriesQuery A secondary query class using the current class as primary query
     */
    public function useCategoryQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinCategory($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Category', '\Propel\Model\CategoriesQuery');
    }

    /**
     * Use the Category relation Categories object
     *
     * @param callable(\Propel\Model\CategoriesQuery):\Propel\Model\CategoriesQuery $callable A function working on the related query
     *
