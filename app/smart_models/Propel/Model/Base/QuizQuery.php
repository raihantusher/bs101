...
use \Exception;
use \PDO;
use Propel\Model\Quiz as ChildQuiz;
...
abstract class QuizQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Propel\Model\Base\QuizQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Propel\\Model\\Quiz', $modelAlias = null)
    {
