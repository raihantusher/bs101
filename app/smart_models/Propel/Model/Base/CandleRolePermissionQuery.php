...
use \Exception;
use \PDO;
use Propel\Model\CandleRolePermission as ChildCandleRolePermission;
...
abstract class CandleRolePermissionQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Propel\Model\Base\CandleRolePermissionQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Propel\\Model\\CandleRolePermission', $modelAlias = null)
    {
