...
use Propel\Propel\CandleModels;
use Propel\Propel\CandleModelsQuery;
...
class CandleModelsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Propel.Map.CandleModelsTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Propel\\CandleModels';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Propel.CandleModels';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\Propel\\CandleModels');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\Propel\CandleModels) { // it's a model object
