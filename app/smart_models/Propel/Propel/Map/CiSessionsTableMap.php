...
use Propel\Propel\CiSessions;
use Propel\Propel\CiSessionsQuery;
...
class CiSessionsTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Propel.Map.CiSessionsTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Propel\\CiSessions';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Propel.CiSessions';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\Propel\\CiSessions');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\Propel\CiSessions) { // it's a model object
