...
use Propel\Propel\OrderProductQuery;
...
class OrderProductTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Propel.Map.OrderProductTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Propel\\OrderProduct';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Propel.OrderProduct';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\Propel\\OrderProduct');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\Propel\OrderProduct) { // it's a model object
