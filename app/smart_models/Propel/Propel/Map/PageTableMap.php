...
class PageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Propel.Map.PageTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Propel\\Page';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Propel.Page';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'Class', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'class', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'Class' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'class' => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\Propel\\Page');
        $this->setPackage('Propel.Propel');
        $this->setUseIdGenerator(true);
        // columns
        $this->addPrimaryKey('id', 'Id', 'INTEGER', true, null, null);
        $this->addColumn('title', 'Name', 'VARCHAR', true, 30, null);
        $this->addColumn('article', 'Class', 'LONGVARCHAR', false, null, null);
    } // initialize()
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\Propel\Page) { // it's a model object
