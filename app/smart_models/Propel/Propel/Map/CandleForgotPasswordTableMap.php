...
use Propel\Propel\CandleForgotPassword;
use Propel\Propel\CandleForgotPasswordQuery;
...
class CandleForgotPasswordTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Propel.Map.CandleForgotPasswordTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Propel\\CandleForgotPassword';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Propel.CandleForgotPassword';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\Propel\\CandleForgotPassword');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\Propel\CandleForgotPassword) { // it's a model object
