...
use Propel\Propel\CandleRolePermission;
use Propel\Propel\CandleRolePermissionQuery;
...
class CandleRolePermissionTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Propel.Propel.Map.CandleRolePermissionTableMap';
     ...
     */
    const OM_CLASS = '\\Propel\\Propel\\CandleRolePermission';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Propel.Propel.CandleRolePermission';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Propel\\Propel\\CandleRolePermission');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Propel\Propel\CandleRolePermission) { // it's a model object
