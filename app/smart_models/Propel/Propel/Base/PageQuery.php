...
use \Exception;
use \PDO;
use Propel\Propel\Page as ChildPage;
 ...
 * @method     ChildPageQuery orderByName($order = Criteria::ASC) Order by the title column
 * @method     ChildPageQuery orderByClass($order = Criteria::ASC) Order by the article column
 *
 * @method     ChildPageQuery groupById() Group by the id column
 * @method     ChildPageQuery groupByName() Group by the title column
 * @method     ChildPageQuery groupByClass() Group by the article column
 *
 ...
 * @method     ChildPage|null findOneByName(string $title) Return the first ChildPage filtered by the title column
 * @method     ChildPage|null findOneByClass(string $article) Return the first ChildPage filtered by the article column *
 ...
 * @method     ChildPage requireOneByName(string $title) Return the first ChildPage filtered by the title column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildPage requireOneByClass(string $article) Return the first ChildPage filtered by the article column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 ...
 * @method     ChildPage[]|ObjectCollection findByName(string $title) Return ChildPage objects filtered by the title column
 * @method     ChildPage[]|ObjectCollection findByClass(string $article) Return ChildPage objects filtered by the article column
...
abstract class PageQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Propel\Propel\Base\PageQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Propel\\Propel\\Page', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, title, article FROM page WHERE id = :p0';
        try {
     ...
     * Example usage:
     * <code>
     * $query->filterByName('fooValue');   // WHERE title = 'fooValue'
     * $query->filterByName('%fooValue%', Criteria::LIKE); // WHERE title LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PageTableMap::COL_TITLE, $name, $comparison);
    }
     ...
     * Example usage:
     * <code>
     * $query->filterByClass('fooValue');   // WHERE article = 'fooValue'
     * $query->filterByClass('%fooValue%', Criteria::LIKE); // WHERE article LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterByClass($class = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PageTableMap::COL_ARTICLE, $class, $comparison);
    }
