...
abstract class Categories implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Propel\\Map\\CategoriesTableMap';
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[CategoriesTableMap::COL_NAME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CategoriesTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = CategoriesTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\Propel\\Categories'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->productsScheduledForDeletion !== null) {
                if (!$this->productsScheduledForDeletion->isEmpty()) {
                    \Propel\Propel\ProductsQuery::create()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CategoriesTableMap::COL_NAME)) {
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Propel\Categories
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\Propel\Categories The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CategoriesTableMap::COL_NAME)) {
            $criteria->add(CategoriesTableMap::COL_NAME, $this->name);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\Propel\Categories (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\Propel\Categories Clone of current object.
     * @throws PropelException
     */
    ...
    public function initProducts($overrideExisting = true)
    {
        ...
        $this->collProducts->setModel('\Propel\Propel\Products');
    }
        ...
        if (null === $this->collProducts || null !== $criteria || $partial) {
            if ($this->isNew()) {
                ...
                if (null === $this->collProducts) {
                    ...
                    $collProducts->setModel('\Propel\Propel\Products');

                    return $collProducts;
                }
            } else {
                $collProducts = ChildProductsQuery::create(null, $criteria)
    ...
    {
        /** @var ChildProducts[] $productsToDelete */
     ...
     * @return $this|\Propel\Propel\Categories The current object (for fluent API support)
     */
    public function addProduct(ChildProducts $l)
    {
        if ($this->collProducts === null) {
            $this->initProducts();
            $this->collProductsPartial = true;
    ...
    /**
     * @param ChildProducts $product The ChildProducts object to add.
     */
    protected function doAddProduct(ChildProducts $product)
    {
    ...
    /**
     * @param  ChildProducts $product The ChildProducts object to remove.
     * @return $this|ChildCategories The current object (for fluent API support)
     */
    public function removeProduct(ChildProducts $product)
    {
