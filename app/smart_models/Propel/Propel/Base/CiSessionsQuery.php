...
use \Exception;
use Propel\Propel\CiSessions as ChildCiSessions;
...
abstract class CiSessionsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Propel\Propel\Base\CiSessionsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Propel\\Propel\\CiSessions', $modelAlias = null)
    {
