...
abstract class Products implements ActiveRecordInterface
{
    ...
    /**
     * The value for the product_cat field.
     *
     * @var        int
     */
    ...
    /**
     * Get the [product_cat] column value.
     *
     * @return int
     */
    ...
    /**
     * Set the value of [product_cat] column.
     *
     * @param int $v New value
     * @return $this|\Propel\Propel\Products The current object (for fluent API support)
     */
    public function setProductCat($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->product_cat !== $v) {
            $this->product_cat = $v;
            $this->modifiedColumns[ProductsTableMap::COL_PRODUCT_CAT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ProductsTableMap::translateFieldName('ProductCat', TableMap::TYPE_PHPNAME, $indexType)];
            $this->product_cat = (null !== $col) ? (int) $col : null;
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProductsTableMap::COL_PRODUCT_CAT)) {
            $modifiedColumns[':p' . $index++]  = 'product_cat';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'price':
                        ...
                        break;
                    case 'product_cat':
                        $stmt->bindValue($identifier, $this->product_cat, PDO::PARAM_INT);
                        break;
                    case 'product_image':
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProductsTableMap::COL_PRODUCT_CAT)) {
            $criteria->add(ProductsTableMap::COL_PRODUCT_CAT, $this->product_cat);
        }
        if ($this->isColumnModified(ProductsTableMap::COL_PRODUCT_IMAGE)) {
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setProductCat($this->getProductCat());
