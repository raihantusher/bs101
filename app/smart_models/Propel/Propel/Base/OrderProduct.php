...
abstract class OrderProduct implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Propel\\Propel\\Map\\OrderProductTableMap';
    ...
    /**
     * Initializes internal state of Propel\Propel\Base\OrderProduct object.
     */
     ...
     * @return $this|\Propel\Propel\OrderProduct The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Propel\\Propel\\OrderProduct'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Propel\Propel\OrderProduct
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Propel\Propel\OrderProduct The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Propel\Propel\OrderProduct (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Propel\Propel\OrderProduct Clone of current object.
     * @throws PropelException
     */
